...
import com.example.android.labbaikatiovani_1202152330_modul6.model.User;
...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databasePost = FirebaseDatabase.getInstance().getReference(HomeActivity.table_1);
        databaseUser = FirebaseDatabase.getInstance().getReference(HomeActivity.table_3);
        //bind data
